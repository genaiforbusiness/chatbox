...
!!! tip "**Custom GitHub Codespace Specification 💡**"
    ...
    * **[Antigravity CLI](https://antigravity.google/):** A terminal-based interface for Google's Antigravity agentic development platform, executed via the `agy` command.
